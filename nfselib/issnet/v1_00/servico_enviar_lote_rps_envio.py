...
#
# Generated Thu Aug  6 20:45:21 2020 by generateDS.py version 2.35.24.
# Python 3.7.8 (default, Jul  8 2020, 14:16:55)  [Clang 11.0.0 (clang-1100.0.33.17)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-f', '')
#   ('-o', './issnet/servico_enviar_lote_rps_envio.py')
#
# Command line arguments:
#   ./issnet/v1_00/servico_enviar_lote_rps_envio.xsd
#
# Command line:
#   /Users/marcelsavegnago/Projetos/odoo/python-libs/issnet-test/venv/bin/generateDS --no-namespace-defs -f -o "./issnet/servico_enviar_lote_rps_envio.py" ./issnet/v1_00/servico_enviar_lote_rps_envio.xsd
#
...
class EnviarLoteRpsEnvio(GeneratedsSuper):
    ...
    def get_LoteRps(self):
        return self.LoteRps
    def set_LoteRps(self, LoteRps):
        self.LoteRps = LoteRps
