...
#   ('-f', '')
#   ('-o', './issnetlib/v1_00/servico_consultar_nfse_rps_resposta.py')
#
# Command line arguments:
#   ./process_includes/servico_consultar_nfse_rps_resposta.xsd
#
# Command line:
#   /Users/marcelsavegnago/Projetos/odoo/python-libs/venv2/bin/erpbrasil-edoc-gen-generate-python --no-namespace-defs --no-collect-includes --use-getter-setter="none" -f -o "./issnetlib/v1_00/servico_consultar_nfse_rps_resposta.py" ./process_includes/servico_consultar_nfse_rps_resposta.xsd
#
