...
#   ('-f', '')
#   ('-o', '/tmp/issnet/issnetlib/v1_00/servico_consultar_nfse_rps_resposta.xsd.py')
#
# Command line arguments:
#   /tmp/generated/schemas/issnet/v1_00/servico_consultar_nfse_rps_resposta.xsd
#
# Command line:
#   /tmp/issnet/bin/generateDS.py --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "/tmp/issnet/issnetlib/v1_00/servico_consultar_nfse_rps_resposta.xsd.py" /tmp/generated/schemas/issnet/v1_00/servico_consultar_nfse_rps_resposta.xsd
#
...
class ConsultarNfseRpsResposta(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('CompNfse', 'tcCompNfse', 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'CompNfse', 'type': 'tcCompNfse'}, 1),
    ...
    subclass = None
    superclass = None
    def __init__(self, CompNfse=None, ListaMensagemRetorno=None, gds_collector_=None, **kwargs_):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ConsultarNfseRpsResposta', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'ConsultarNfseRpsResposta':
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from servico_consultar_nfse_rps_resposta.xsd import *\n\n')
        sys.stdout.write('import servico_consultar_nfse_rps_resposta.xsd as model_\n\n')
...
NamespaceToDefMappings_ = {'http://www.issnetonline.com.br/webserviceabrasf/vsd/servico_consultar_nfse_rps_resposta.xsd': [],
