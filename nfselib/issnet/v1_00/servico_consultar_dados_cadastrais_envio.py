...
#   ('-f', '')
#   ('-o', '/tmp/issnet/issnetlib/v1_00/servico_consultar_dados_cadastrais_envio.xsd.py')
#
# Command line arguments:
#   /tmp/generated/schemas/issnet/v1_00/servico_consultar_dados_cadastrais_envio.xsd
#
# Command line:
#   /tmp/issnet/bin/generateDS.py --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "/tmp/issnet/issnetlib/v1_00/servico_consultar_dados_cadastrais_envio.xsd.py" /tmp/generated/schemas/issnet/v1_00/servico_consultar_dados_cadastrais_envio.xsd
#
...
class ConsultarDadosCadastraisEnvio(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('Prestador', 'xsd:string', 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'Prestador', 'type': 'xsd:string'}, None),
        MemberSpec_('Signature', 'SignatureType', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'Signature', 'ref': 'Signature', 'type': 'Signature'}, None),
    ]
    subclass = None
    superclass = None
    def __init__(self, Prestador=None, Signature=None, gds_collector_=None, **kwargs_):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ConsultarDadosCadastraisEnvio)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ConsultarDadosCadastraisEnvio.subclass:
            return ConsultarDadosCadastraisEnvio.subclass(*args_, **kwargs_)
        else:
            return ConsultarDadosCadastraisEnvio(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ConsultarDadosCadastraisEnvio', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ConsultarDadosCadastraisEnvio')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'ConsultarDadosCadastraisEnvio':
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ConsultarDadosCadastraisEnvio')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='ConsultarDadosCadastraisEnvio', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ConsultarDadosCadastraisEnvio'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ConsultarDadosCadastraisEnvio', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Prestador is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sPrestador>%s</%sPrestador>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.Prestador), input_name='Prestador')), namespaceprefix_ , eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Prestador':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'Prestador')
            value_ = self.gds_validate_string(value_, node, 'Prestador')
            self.Prestador = value_
            self.Prestador_nsprefix_ = child_.prefix
        elif nodeName_ == 'Signature':
            obj_ = SignatureType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.Signature = obj_
            obj_.original_tagname_ = 'Signature'
# end class ConsultarDadosCadastraisEnvio
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'ConsultarDadosCadastraisEnvio'
        rootClass = ConsultarDadosCadastraisEnvio
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from servico_consultar_dados_cadastrais_envio.xsd import *\n\n')
        sys.stdout.write('import servico_consultar_dados_cadastrais_envio.xsd as model_\n\n')
...
NamespaceToDefMappings_ = {'http://www.issnetonline.com.br/webserviceabrasf/vsd/servico_consultar_dados_cadastrais_envio.xsd': [],
