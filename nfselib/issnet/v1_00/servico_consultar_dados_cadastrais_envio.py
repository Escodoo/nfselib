...
#
# Generated Tue Aug  4 16:43:27 2020 by generateDS.py version 2.30.15.
# Python 3.8.5 (default, Jul 21 2020, 10:42:08)  [Clang 11.0.0 (clang-1100.0.33.17)]
#
# Command line options:
#   ('-f', '')
#   ('-o', 'servico_consultar_dados_cadastrais_envio.py')
#
# Command line arguments:
#   servico_consultar_dados_cadastrais_envio.xsd
#
# Command line:
#   /Users/marcelsavegnago/Projetos/odoo/python-libs/issnet-test/bin/generateDS -f -o "servico_consultar_dados_cadastrais_envio.py" servico_consultar_dados_cadastrais_envio.xsd
#
...
class ConsultarDadosCadastraisEnvio(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, Prestador=None, Signature=None, **kwargs_):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:tc="http://www.issnetonline.com.br/webserviceabrasf/vsd/tipos_complexos.xsd"  xmlns:dsig="http://www.w3.org/2000/09/xmldsig#" ', name_='ConsultarDadosCadastraisEnvio', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ConsultarDadosCadastraisEnvio'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:tc="http://www.issnetonline.com.br/webserviceabrasf/vsd/tipos_complexos.xsd"  xmlns:dsig="http://www.w3.org/2000/09/xmldsig#" ', name_='ConsultarDadosCadastraisEnvio', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Prestador':
            Prestador_ = child_.text
            Prestador_ = self.gds_validate_string(Prestador_, node, 'Prestador')
            self.Prestador = Prestador_
