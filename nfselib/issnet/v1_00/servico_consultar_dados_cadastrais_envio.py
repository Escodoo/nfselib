...
#
# Generated Fri Aug  7 04:14:19 2020 by generateDS.py version 2.35.24.
# Python 3.7.8 (default, Jul  8 2020, 14:16:55)  [Clang 11.0.0 (clang-1100.0.33.17)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-f', '')
#   ('-o', './issnet/servico_consultar_dados_cadastrais_envio.py')
#
# Command line arguments:
#   ./issnet/v1_00/servico_consultar_dados_cadastrais_envio.xsd
#
# Command line:
#   /Users/marcelsavegnago/Projetos/odoo/python-libs/issnet-test/venv/bin/generateDS --no-namespace-defs -f -o "./issnet/servico_consultar_dados_cadastrais_envio.py" ./issnet/v1_00/servico_consultar_dados_cadastrais_envio.xsd
#
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from servico_consultar_dados_cadastrais_envio import *\n\n')
        sys.stdout.write('import servico_consultar_dados_cadastrais_envio as model_\n\n')
