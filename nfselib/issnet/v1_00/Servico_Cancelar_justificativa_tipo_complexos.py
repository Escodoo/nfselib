...
#   ('-f', '')
#   ('-o', '/tmp/issnet/issnetlib/v1_00/Servico_Cancelar_justificativa_tipo_complexos.xsd.py')
#
# Command line arguments:
#   /tmp/generated/schemas/issnet/v1_00/Servico_Cancelar_justificativa_tipo_complexos.xsd
#
# Command line:
#   /tmp/issnet/bin/generateDS.py --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "/tmp/issnet/issnetlib/v1_00/Servico_Cancelar_justificativa_tipo_complexos.xsd.py" /tmp/generated/schemas/issnet/v1_00/Servico_Cancelar_justificativa_tipo_complexos.xsd
#
...
class tcAtividade(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('CodigoAtividade', 'xsd:string', 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'CodigoAtividade', 'type': 'xsd:string'}, None),
        MemberSpec_('DescricaoAtividade', 'xsd:string', 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'DescricaoAtividade', 'type': 'xsd:string'}, None),
        MemberSpec_('Aliquota', ['tsValor', 'xsd:decimal'], 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'Aliquota', 'type': 'xsd:decimal'}, None),
        MemberSpec_('VigenciaInicial', 'xsd:date', 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'VigenciaInicial', 'type': 'xsd:date'}, None),
        MemberSpec_('VigenciaFinal', 'xsd:date', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'VigenciaFinal', 'type': 'xsd:date'}, None),
    ]
    subclass = None
    superclass = None
...
class tcSimplesNacional(GeneratedsSuper):
    ...
    member_data_items_ = [
        ...
        MemberSpec_('VigenciaInicial', 'xsd:date', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'VigenciaInicial', 'type': 'xsd:date'}, None),
        MemberSpec_('VigenciaFinal', 'xsd:date', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'VigenciaFinal', 'type': 'xsd:date'}, None),
    ]
    subclass = None
    superclass = None
...
class tcMei(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('Mei', ['tsSimNao', 'xsd:byte'], 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'Mei', 'type': 'xsd:byte'}, None),
        MemberSpec_('VigenciaInicial', 'xsd:date', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'VigenciaInicial', 'type': 'xsd:date'}, None),
        MemberSpec_('VigenciaFinal', 'xsd:date', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'VigenciaFinal', 'type': 'xsd:date'}, None),
    ]
    subclass = None
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Mei' and child_.text:
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'Mei')
...
class tcCnae(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('CodigoCnae', 'xsd:string', 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'CodigoCnae', 'type': 'xsd:string'}, None),
        MemberSpec_('DescricaoCnae', 'xsd:string', 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'DescricaoCnae', 'type': 'xsd:string'}, None),
        MemberSpec_('Principal', ['tsSimNao', 'xsd:byte'], 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'Principal', 'type': 'xsd:byte'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'CodigoCnae':
            ...
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'Principal')
...
class tcNaturezaOperacao(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('CodigoNaturezaOperacao', ['tsNaturezaOperacao', 'xsd:byte'], 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'CodigoNaturezaOperacao', 'type': 'xsd:byte'}, None),
        MemberSpec_('DescricaoNaturezaOperacao', 'xsd:string', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'DescricaoNaturezaOperacao', 'type': 'xsd:string'}, None),
        MemberSpec_('VigenciaInicial', 'xsd:date', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'VigenciaInicial', 'type': 'xsd:date'}, None),
        MemberSpec_('VigenciaFinal', 'xsd:date', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'VigenciaFinal', 'type': 'xsd:date'}, None),
    ]
    subclass = None
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'CodigoNaturezaOperacao' and child_.text:
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'CodigoNaturezaOperacao')
...
class tcInfPedidoCancelamento(GeneratedsSuper):
    ...
    member_data_items_ = [
        ...
        MemberSpec_('MotivoCancelamentoNfse', 'xsd:string', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'MotivoCancelamentoNfse', 'type': 'xsd:string'}, None),
    ]
    subclass = None
    superclass = None
...
class tcCompNfse(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('Nfse', 'tcNfse', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'Nfse', 'type': 'tcNfse'}, None),
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from Servico_Cancelar_justificativa_tipo_complexos.xsd import *\n\n')
        sys.stdout.write('import Servico_Cancelar_justificativa_tipo_complexos.xsd as model_\n\n')
