...
#
# Generated Fri Aug  7 04:11:15 2020 by generateDS.py version 2.35.24.
# Python 3.7.8 (default, Jul  8 2020, 14:16:55)  [Clang 11.0.0 (clang-1100.0.33.17)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-f', '')
#   ('-o', './issnet/Servico_Cancelar_justificativa_tipo_complexos.py')
#
# Command line arguments:
#   ./issnet/v1_00/Servico_Cancelar_justificativa_tipo_complexos.xsd
#
# Command line:
#   /Users/marcelsavegnago/Projetos/odoo/python-libs/issnet-test/venv/bin/generateDS --no-namespace-defs -f -o "./issnet/Servico_Cancelar_justificativa_tipo_complexos.py" ./issnet/v1_00/Servico_Cancelar_justificativa_tipo_complexos.xsd
#
...
class tcInfPedidoCancelamento(GeneratedsSuper):
    ...
    def __init__(self, id=None, IdentificacaoNfse=None, CodigoCancelamento=None, MotivoCancelamentoNfse=None, gds_collector_=None, **kwargs_):
        ...
        self.MotivoCancelamentoNfse_nsprefix_ = 'tc'
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
