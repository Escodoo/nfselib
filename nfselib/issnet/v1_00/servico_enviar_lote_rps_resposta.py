...
#   ('-f', '')
#   ('-o', '/tmp/issnet/issnetlib/v1_00/servico_enviar_lote_rps_resposta.xsd.py')
#
# Command line arguments:
#   /tmp/generated/schemas/issnet/v1_00/servico_enviar_lote_rps_resposta.xsd
#
# Command line:
#   /tmp/issnet/bin/generateDS.py --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "/tmp/issnet/issnetlib/v1_00/servico_enviar_lote_rps_resposta.xsd.py" /tmp/generated/schemas/issnet/v1_00/servico_enviar_lote_rps_resposta.xsd
#
