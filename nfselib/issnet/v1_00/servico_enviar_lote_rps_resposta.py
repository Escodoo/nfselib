...
#
# Generated Thu Aug  6 20:45:36 2020 by generateDS.py version 2.35.24.
# Python 3.7.8 (default, Jul  8 2020, 14:16:55)  [Clang 11.0.0 (clang-1100.0.33.17)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-f', '')
#   ('-o', './issnet/servico_enviar_lote_rps_resposta.py')
#
# Command line arguments:
#   ./issnet/v1_00/servico_enviar_lote_rps_resposta.xsd
#
# Command line:
#   /Users/marcelsavegnago/Projetos/odoo/python-libs/issnet-test/venv/bin/generateDS --no-namespace-defs -f -o "./issnet/servico_enviar_lote_rps_resposta.py" ./issnet/v1_00/servico_enviar_lote_rps_resposta.xsd
#
...
class EnviarLoteRpsResposta(GeneratedsSuper):
    ...
    def set_NumeroLote(self, NumeroLote):
        self.NumeroLote = NumeroLote
    def get_DataRecebimento(self):
        return self.DataRecebimento
    def set_DataRecebimento(self, DataRecebimento):
