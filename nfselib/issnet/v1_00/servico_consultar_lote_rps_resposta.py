...
#
# Generated Fri Aug  7 04:16:13 2020 by generateDS.py version 2.35.24.
# Python 3.7.8 (default, Jul  8 2020, 14:16:55)  [Clang 11.0.0 (clang-1100.0.33.17)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-f', '')
#   ('-o', './issnet/servico_consultar_lote_rps_resposta.py')
#
# Command line arguments:
#   ./issnet/v1_00/servico_consultar_lote_rps_resposta.xsd
#
# Command line:
#   /Users/marcelsavegnago/Projetos/odoo/python-libs/issnet-test/venv/bin/generateDS --no-namespace-defs -f -o "./issnet/servico_consultar_lote_rps_resposta.py" ./issnet/v1_00/servico_consultar_lote_rps_resposta.xsd
#
...
class ConsultarLoteRpsResposta(GeneratedsSuper):
    ...
    def get_ListaNfse(self):
        return self.ListaNfse
    def set_ListaNfse(self, ListaNfse):
        self.ListaNfse = ListaNfse
...
class ListaNfseType(GeneratedsSuper):
    ...
    def set_CompNfse(self, CompNfse):
        self.CompNfse = CompNfse
    def add_CompNfse(self, value):
        self.CompNfse.append(value)
    def insert_CompNfse_at(self, index, value):
        self.CompNfse.insert(index, value)
    def replace_CompNfse_at(self, index, value):
        self.CompNfse[index] = value
    def hasContent_(self):
        if (
            self.CompNfse
        ):
