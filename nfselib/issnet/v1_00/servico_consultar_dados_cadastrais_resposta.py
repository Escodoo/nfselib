...
#   ('-f', '')
#   ('-o', '/tmp/issnet/issnetlib/v1_00/servico_consultar_dados_cadastrais_resposta.xsd.py')
#
# Command line arguments:
#   /tmp/generated/schemas/issnet/v1_00/servico_consultar_dados_cadastrais_resposta.xsd
#
# Command line:
#   /tmp/issnet/bin/generateDS.py --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "/tmp/issnet/issnetlib/v1_00/servico_consultar_dados_cadastrais_resposta.xsd.py" /tmp/generated/schemas/issnet/v1_00/servico_consultar_dados_cadastrais_resposta.xsd
#
...
class ConsultarDadosCadastraisResposta(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('IdentificacaoPrestador', 'tcIdentificacaoPrestador', 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'IdentificacaoPrestador', 'type': 'tcIdentificacaoPrestador'}, 1),
        MemberSpec_('RazaoSocial', ['tsRazaoSocial', 'xsd:string'], 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'RazaoSocial', 'type': 'xsd:string'}, 1),
        MemberSpec_('ListaCnae', 'ListaCnaeType', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'ListaCnae', 'type': 'ListaCnaeType'}, 1),
        MemberSpec_('ListaAtividade', 'ListaAtividadeType', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'ListaAtividade', 'type': 'ListaAtividadeType'}, 1),
        MemberSpec_('ListaNaturezaOperacao', 'ListaNaturezaOperacaoType', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'ListaNaturezaOperacao', 'type': 'ListaNaturezaOperacaoType'}, 1),
        MemberSpec_('ListaSimplesNacional', 'ListaSimplesNacionalType', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'ListaSimplesNacional', 'type': 'ListaSimplesNacionalType'}, 1),
        MemberSpec_('ListaMei', 'ListaMeiType', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'ListaMei', 'type': 'ListaMeiType'}, 1),
        MemberSpec_('PermiteDeducao', ['tsSimNao', 'xsd:byte'], 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'PermiteDeducao', 'type': 'xsd:byte'}, 1),
        MemberSpec_('PermiteDescontoIncondicionado', ['tsSimNao', 'xsd:byte'], 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'PermiteDescontoIncondicionado', 'type': 'xsd:byte'}, 1),
        MemberSpec_('PermiteDescontoCondicionado', ['tsSimNao', 'xsd:byte'], 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'PermiteDescontoCondicionado', 'type': 'xsd:byte'}, 1),
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'IdentificacaoPrestador':
            ...
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'PermiteDeducao')
            ...
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'PermiteDescontoIncondicionado')
            ...
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'PermiteDescontoCondicionado')
...
class ListaCnaeType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('Cnae', 'xsd:string', 1, 0, {'maxOccurs': 'unbounded', 'minOccurs': '1', 'name': 'Cnae', 'type': 'xsd:string'}, None),
    ]
    subclass = None
    superclass = None
...
class ListaAtividadeType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('Atividade', 'xsd:string', 1, 0, {'maxOccurs': 'unbounded', 'minOccurs': '1', 'name': 'Atividade', 'type': 'xsd:string'}, None),
    ]
    subclass = None
    superclass = None
...
class ListaNaturezaOperacaoType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('NaturezaOperacao', 'xsd:string', 1, 0, {'maxOccurs': 'unbounded', 'minOccurs': '1', 'name': 'NaturezaOperacao', 'type': 'xsd:string'}, None),
    ]
    subclass = None
    superclass = None
...
class ListaSimplesNacionalType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('SimplesNacional', 'xsd:string', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'SimplesNacional', 'type': 'xsd:string'}, None),
    ]
    subclass = None
    superclass = None
...
class ListaMeiType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('Mei', 'xsd:string', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'Mei', 'type': 'xsd:string'}, None),
    ]
    subclass = None
    superclass = None
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from servico_consultar_dados_cadastrais_resposta.xsd import *\n\n')
        sys.stdout.write('import servico_consultar_dados_cadastrais_resposta.xsd as model_\n\n')
