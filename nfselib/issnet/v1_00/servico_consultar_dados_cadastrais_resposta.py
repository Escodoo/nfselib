...
#
# Generated Tue Aug  4 16:44:23 2020 by generateDS.py version 2.30.15.
# Python 3.8.5 (default, Jul 21 2020, 10:42:08)  [Clang 11.0.0 (clang-1100.0.33.17)]
#
# Command line options:
#   ('-f', '')
#   ('-o', 'servico_consultar_dados_cadastrais_resposta.py')
#
# Command line arguments:
#   servico_consultar_dados_cadastrais_resposta.xsd
#
# Command line:
#   /Users/marcelsavegnago/Projetos/odoo/python-libs/issnet-test/bin/generateDS -f -o "servico_consultar_dados_cadastrais_resposta.py" servico_consultar_dados_cadastrais_resposta.xsd
#
...
class ConsultarDadosCadastraisResposta(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:tc="http://www.issnetonline.com.br/webserviceabrasf/vsd/tipos_complexos.xsd"  xmlns:ts="http://www.issnetonline.com.br/webserviceabrasf/vsd/tipos_simples.xsd"  xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='ConsultarDadosCadastraisResposta', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ConsultarDadosCadastraisResposta'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:tc="http://www.issnetonline.com.br/webserviceabrasf/vsd/tipos_complexos.xsd"  xmlns:ts="http://www.issnetonline.com.br/webserviceabrasf/vsd/tipos_simples.xsd"  xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='ConsultarDadosCadastraisResposta', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ListaAtividadeType(GeneratedsSuper):
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Atividade':
            Atividade_ = child_.text
            Atividade_ = self.gds_validate_string(Atividade_, node, 'Atividade')
            self.Atividade.append(Atividade_)
...
class ListaNaturezaOperacaoType(GeneratedsSuper):
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'NaturezaOperacao':
            NaturezaOperacao_ = child_.text
            NaturezaOperacao_ = self.gds_validate_string(NaturezaOperacao_, node, 'NaturezaOperacao')
            self.NaturezaOperacao.append(NaturezaOperacao_)
...
class ListaSimplesNacionalType(GeneratedsSuper):
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'SimplesNacional':
            SimplesNacional_ = child_.text
            SimplesNacional_ = self.gds_validate_string(SimplesNacional_, node, 'SimplesNacional')
            self.SimplesNacional = SimplesNacional_
...
class ListaMeiType(GeneratedsSuper):
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Mei':
            Mei_ = child_.text
            Mei_ = self.gds_validate_string(Mei_, node, 'Mei')
            self.Mei = Mei_
