...
#   ('-f', '')
#   ('-o', '/tmp/issnet/issnetlib/v1_00/servico_consultar_nfse_envio.xsd.py')
#
# Command line arguments:
#   /tmp/generated/schemas/issnet/v1_00/servico_consultar_nfse_envio.xsd
#
# Command line:
#   /tmp/issnet/bin/generateDS.py --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "/tmp/issnet/issnetlib/v1_00/servico_consultar_nfse_envio.xsd.py" /tmp/generated/schemas/issnet/v1_00/servico_consultar_nfse_envio.xsd
#
...
class ConsultarNfseEnvio(GeneratedsSuper):
    ...
    member_data_items_ = [
        ...
        MemberSpec_('NumeroNfse', ['tsNumeroNfse', 'xsd:nonNegativeInteger'], 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'NumeroNfse', 'type': 'xsd:nonNegativeInteger'}, None),
        MemberSpec_('PeriodoEmissao', 'PeriodoEmissaoType', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'PeriodoEmissao', 'type': 'PeriodoEmissaoType'}, None),
        MemberSpec_('Tomador', 'tcIdentificacaoTomador', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'Tomador', 'type': 'tcIdentificacaoTomador'}, None),
    ...
    subclass = None
    superclass = None
    def __init__(self, Prestador=None, NumeroNfse=None, PeriodoEmissao=None, Tomador=None, IntermediarioServico=None, gds_collector_=None, **kwargs_):
        ...
        self.NumeroNfse_nsprefix_ = None
        self.PeriodoEmissao = PeriodoEmissao
        self.PeriodoEmissao_nsprefix_ = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ConsultarNfseEnvio', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'ConsultarNfseEnvio':
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ConsultarNfseEnvio', fromsubclass_=False, pretty_print=True):
        ...
        if self.NumeroNfse is not None:
            namespaceprefix_ = self.NumeroNfse_nsprefix_ + ':' if (UseCapturedNS_ and self.NumeroNfse_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        if self.PeriodoEmissao is not None:
            namespaceprefix_ = self.PeriodoEmissao_nsprefix_ + ':' if (UseCapturedNS_ and self.PeriodoEmissao_nsprefix_) else ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Prestador':
            ...
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'NumeroNfse')
            if ival_ < 0:
                raise_parse_error(child_, 'requires nonNegativeInteger')
            ival_ = self.gds_validate_integer(ival_, node, 'NumeroNfse')
            self.NumeroNfse = ival_
            self.NumeroNfse_nsprefix_ = child_.prefix
...
class PeriodoEmissaoType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('DataInicial', 'xsd:date', 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'DataInicial', 'type': 'xsd:date'}, None),
        MemberSpec_('DataFinal', 'xsd:date', 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'DataFinal', 'type': 'xsd:date'}, None),
    ]
    subclass = None
    superclass = None
    def __init__(self, DataInicial=None, DataFinal=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.DataInicial_nsprefix_ = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PeriodoEmissaoType', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'PeriodoEmissaoType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PeriodoEmissaoType', fromsubclass_=False, pretty_print=True):
        ...
        if self.DataInicial is not None:
            namespaceprefix_ = self.DataInicial_nsprefix_ + ':' if (UseCapturedNS_ and self.DataInicial_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        if self.DataFinal is not None:
            namespaceprefix_ = self.DataFinal_nsprefix_ + ':' if (UseCapturedNS_ and self.DataFinal_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'DataInicial':
            ...
            self.DataInicial_nsprefix_ = child_.prefix
        elif nodeName_ == 'DataFinal':
            sval_ = child_.text
            dval_ = self.gds_parse_date(sval_)
            self.DataFinal = dval_
            self.DataFinal_nsprefix_ = child_.prefix
...
def parseString(inString, silence=False, print_warnings=True):
    ...
    if not silence:
        ...
        rootObj.export(
            sys.stdout, 0, name_=rootTag,
            namespacedef_='xmlns:NS="http://www.issnetonline.com.br/webserviceabrasf/vsd/servico_consultar_nfse_envio.xsd"')
    if print_warnings and len(gds_collector.get_messages()) > 0:
        separator = ('-' * 50) + '\n'
        sys.stderr.write(separator)
        sys.stderr.write('----- Warnings -- count: {} -----\n'.format(
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from servico_consultar_nfse_envio.xsd import *\n\n')
        sys.stdout.write('import servico_consultar_nfse_envio.xsd as model_\n\n')
...
NamespaceToDefMappings_ = {'http://www.issnetonline.com.br/webserviceabrasf/vsd/servico_consultar_nfse_envio.xsd': [],
