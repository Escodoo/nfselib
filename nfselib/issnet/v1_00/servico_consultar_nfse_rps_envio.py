...
#
# Generated Tue Aug  4 16:46:52 2020 by generateDS.py version 2.30.15.
# Python 3.8.5 (default, Jul 21 2020, 10:42:08)  [Clang 11.0.0 (clang-1100.0.33.17)]
#
# Command line options:
#   ('-f', '')
#   ('-o', 'servico_consultar_nfse_rps_envio.py')
#
# Command line arguments:
#   servico_consultar_nfse_rps_envio.xsd
#
# Command line:
#   /Users/marcelsavegnago/Projetos/odoo/python-libs/issnet-test/bin/generateDS -f -o "servico_consultar_nfse_rps_envio.py" servico_consultar_nfse_rps_envio.xsd
#
...
class ConsultarNfseRpsEnvio(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:tc="http://www.issnetonline.com.br/webserviceabrasf/vsd/tipos_complexos.xsd" ', name_='ConsultarNfseRpsEnvio', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ConsultarNfseRpsEnvio'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:tc="http://www.issnetonline.com.br/webserviceabrasf/vsd/tipos_complexos.xsd" ', name_='ConsultarNfseRpsEnvio', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
