...
#
# Generated Tue Aug  4 16:48:11 2020 by generateDS.py version 2.30.15.
# Python 3.8.5 (default, Jul 21 2020, 10:42:08)  [Clang 11.0.0 (clang-1100.0.33.17)]
#
# Command line options:
#   ('-f', '')
#   ('-o', 'servico_consultar_situacao_lote_rps_resposta.py')
#
# Command line arguments:
#   servico_consultar_situacao_lote_rps_resposta.xsd
#
# Command line:
#   /Users/marcelsavegnago/Projetos/odoo/python-libs/issnet-test/bin/generateDS -f -o "servico_consultar_situacao_lote_rps_resposta.py" servico_consultar_situacao_lote_rps_resposta.xsd
#
...
class ConsultarSituacaoLoteRpsResposta(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:ts="http://www.issnetonline.com.br/webserviceabrasf/vsd/tipos_simples.xsd"  xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='ConsultarSituacaoLoteRpsResposta', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ConsultarSituacaoLoteRpsResposta'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:ts="http://www.issnetonline.com.br/webserviceabrasf/vsd/tipos_simples.xsd"  xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='ConsultarSituacaoLoteRpsResposta', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
